...
con_da1 = {'type': 'eq', 'fun': da1}
con_db1 = {'type': 'eq', 'fun': db1}

con_da2 = {'type': 'eq', 'fun': da2}
con_db2 = {'type': 'eq', 'fun': db2}

con_da3 = {'type': 'eq', 'fun': da3}
con_db3 = {'type': 'eq', 'fun': db3}

con_da4 = {'type': 'eq', 'fun': da4}
con_db4 = {'type': 'eq', 'fun': db4}

con_da5 = {'type': 'eq', 'fun': da5}
con_db5 = {'type': 'eq', 'fun': db5}
